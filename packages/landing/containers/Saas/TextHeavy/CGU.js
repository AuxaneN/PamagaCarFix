...
import Wrapper from './TextHeavy.styles'
...
const CGU = () => (
  <Wrapper>
  <Container>
    <Heading content="Conditions générales d'utilisation" />
      <TextPage title="Préambule">
      <>
    ...
    <TextPage title="Article 1 - Principes">
      <>
      <p>Les présentes conditions générales d'utilisation ont pour objet l'encadrement juridique de l’utilisation du site Pamaga Car et de ses services.</p>
      <ul>
      Le site Internet www.pamagacar.com est un service de : 
        <li>
        La société  Pamaga Car
        </li>
        <li>
        située 85 rue Damrémont 75018 Paris, france
        </li>
        <li>
        adresse URL du site : www.pamagacar.com
        </li>
        <li>
        e-mail : pamagacar@gmail.com
        </li>
        <li>
        numéro de téléphone : 0757455566
        </li>
      </ul>
    ...
    <TextPage title="Article 2 - Evolution et durée des CGU">
      <p>
        ...
        Le site Pamaga Car se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.
      </p>
    </TextPage>
    <TextPage title="Article 3 - Accès au site">
      <>
      <p>
        Tout Utilisateur ayant accès à internet peut accéder gratuitement et depuis n’importe où au site Pamaga Car. Les frais supportés par l’Utilisateur pour y accéder (connexion internet, matériel informatique, etc.) ne sont pas à la charge de l’Éditeur.
      </p>
      <p>
      ...
      <p>
        L'Utilisateur du site a accès aux services suivants : véhicule .
      </p>
      </>
    </TextPage>
    <TextPage title="Article 4  - Responsabilités ">
      <>
      <p>
      ...
      Si l'Éditeur venait à faire l'objet d'une procédure amiable ou judiciaire à raison de  l'utilisation du site  <br />par l'Utilisateur, il pourra retourner contre lui pour obtenir indemnisation de tous les préjudices, sommes, condamnations et frais qui pourraient découler de cette procédure.
      </p>
      </>
    </TextPage>
    <TextPage title="Article 5  - Propriété intellectuelle">
      <>
      <p>
      Tous les documents techniques, produits, photographies, textes, logos, dessins, vidéos, etc., sont soumis à des droits d'auteur et sont protégés par le Code de la propriété intellectuelle. Lorsqu'ils sont remis à nos clients, ils demeurent la propriété exclusive de Pamaga Car, seul titulaire des droits de propriété intellectuelle sur ces documents, qui doivent lui être rendus à sa demande. <br />
    ...
    <TextPage title="Article 6  - Liens hypertextes">
      <>
        <p>La mise en place par l'Utilisateur de tous liens hypertextes vers tout ou partie du site est strictement interdite, sauf autorisation préalable et écrite de l'Éditeur, sollicitée par courriel à l'adresse suivante : pamagacar@gmail.com.</p>
    ...
    <TextPage title="Article 7 - Protection des données personnelles">
      <>
        ...
        <strong>Mise en oeuvre des droits des utilisateurs</strong>
          <p>
          En application de la réglementation applicable aux données à caractère personnel, les utilisateurs disposent des droits suivants, qu'ils peuvent exercer en faisant leur demande à l'adresse suivante : pamagacar@gmail.com.
          </p>
          <ol>
          ...
          <strong>Evolution de la présente clause</strong>
            <p>
    ...
    <TextPage title="Article 8  - Cookies">
      <p>Le site Pamaga Car peut collecter automatiquement des informations standards. Toutes les informations collectées indirectement ne seront utilisées que pour suivre le volume, le type et la configuration du trafic utilisant ce site, pour en développer la conception et l'agencement et à d'autres fins administratives et de planification et plus généralement pour améliorer le service que nous vous offrons.</p>
    </TextPage>
    <TextPage title="Article 9 - Loi applicable">
