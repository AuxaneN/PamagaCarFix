...
import {FormDevis} from '../../../../common/src/components/Form/FormDevis';
  ...
  return (
    <Box {...this.props.sectionWrapper}>
      <Container>
        ...
        <Box {...this.props.row}>
          <Box>
              <Button {...this.props.button} title="DEMANDER UN DEVIS" onClick={this.handleClick}/>
          </Box>
        </Box>
        <FormDevis hidden={this.state.formHidden} click={this.formHide} id={this.props.id}/>
      </Container>
    </Box>
  );}
};
