...
import {FormReprise} from '../../../../common/src/components/Form/FormReprise';
  ...
  return (
    <Box {...this.props.sectionWrapper}>
      <Container>
        ...
        <Box {...this.props.row}>
          <Box>
              <Button {...this.props.button} title="Ma demande de reprise" onClick={this.handleClick}/>
          </Box>
        </Box>
        <FormReprise hidden={this.state.formHidden} click={this.formHide} id={this.props.id}/>
      </Container>
    </Box>
  );}
};
