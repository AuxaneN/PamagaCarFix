...
import Illustration from '../../../../common/src/assets/image/saas/illustrationtest.png';
    ...
    <Box {...sectionWrapper}>
      <Container>
        <Box {...sectionHeader}>
          <Heading
            {...sectionTitle}
            content="Les étapes d’achat de votre véhicule avec PAMAGA CAR"
          />
        </Box>
        <Box {...row}>
          <Box {...col} {...imageArea}>
...
TimelineSection.defaultProps = {
  ...
  indexStyle: {
    fontSize: ['26px', '32px', '42px', '46px', '52px'],
    fontWeight: '300',
    color: '#ef4923',
    display: 'block',
    lineHeight: '1',
